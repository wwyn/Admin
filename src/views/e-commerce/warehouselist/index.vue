<template>
  <div class="list">
    ...
    <brandlist :table-data="tableData" @handleSelectionChange="handleSelectionChange" @handleEditor="handleEditor" @handleupSelling="handleupSelling" @handleDel="handleDel"></brandlist>
    <!-- <div class="block">
      <el-pagination
