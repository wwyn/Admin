<template>
  <div class="list">
    ...
    <brandlist :table-data="tableData" :sell="true" @handleSelectionChange="handleSelectionChange" @handleEditor="handleEditor" @handleupSelling="handleupSelling" @handleDel="handleDel"></brandlist>
    ...
    async productList(params) {
      ...
      try {
        ...
        if (ret.data.code == 200 && ret.data.data) {
          console.log(ret,ret.data.data.pageData.length, "列表成功");
