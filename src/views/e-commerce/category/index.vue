    ...
    async getSpecs(query) {
      ...
      try {
        ...
        if (_type === 0) {
          ...
          console.log(ret, this.toolsListdefault, "获取默认规格");
        } else if (_type != 0) {
          this.toolsListcustomize = ret.data.data || [];
          console.log(ret, "获取自定义规格");
        }
        if (ret.data.code == 200) {
        }
      } catch (err) {
